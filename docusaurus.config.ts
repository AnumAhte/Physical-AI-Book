...
const config: Config = {
  ...
  tagline: 'AI-Native Textbook: From ROS 2 to Vision-Language-Action Systems',
      ...
      links: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              to: '/docs/week-03-05-ros2/ros2-overview',
            },
            {
              label: 'Capstone Project',
              to: '/docs/week-13-capstone/capstone-overview',
            },
          ],
        },
        {
